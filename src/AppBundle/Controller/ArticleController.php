...
class ArticleController extends Controller
{
     ...
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request, SlugGenerator $slugGenerator)
    {
        $article = new Article();
     ...
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Article $article, SlugGenerator $slugGenerator)
    {
        $deleteForm = $this->createDeleteForm($article);
